      ...
      <div>
        ...
        <div className="first-sec">
          <div className="row offset-1">
            <div className="col-6 ">
              <h3>Goodbye doubts,</h3>
              <br />
              <h1>Say Hello Doctor.</h1>
              <br />
              <hr />
              <h3>24/7 Video Consultation</h3>
            </div>
            <div className="col-6 ">
              <img src={conference} alt="conference" id="banner-img" />
            </div>
          </div>
        </div>
        ...
        <div className="second-sec container">
          <div className="row">
            ...
            <div className="col-md-3 doc-text">
              ...
              <p>
                Tell Us your health concern and we will assign you a doctor in
                60secs.
              </p>
